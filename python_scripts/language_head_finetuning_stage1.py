...
# ============================================================================
logger.info("[2/9] Loading dataset...")
dataset_id = "xuyige/ASDiv-Aug"

# Load datasets in streaming mode for memory efficiency
train_set = load_dataset("json", data_files="/home/ie643_mindspring/datasets/stage1_mixed_one_two_ops_15000.jsonl")["train"]
...
# ============================================================================
logger.info("[3/9] Loading processor...")
...
# DATASET FORMATTING
# ============================================================================
logger.info("[4/9] Formatting datasets...")
...
logger.info("✓ Datasets formatted successfully")
    ...
    def __call__(self, examples: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for i in range(len(labels)):
            ...
            if len(response_start) > 0:
                ...
                labels[i, : response_start[-2] + 2] = -100
...
# ============================================================================
logger.info("[5/9] Loading base model...")
...
model = PeftModel.from_pretrained(model, "/home/ie643_mindspring/model_weights/training-language-head-simple-arithmetics-stage1/checkpoint-300", is_trainable=True)

# ============================================================================
# LORA (PEFT) CONFIGURATION
# ============================================================================
logger.info("[6/9] Configuring LoRA adapters...")


# LoRA configuration for parameter-efficient fine-tuning
# peft_config = LoraConfig(
#     r=32,  # LoRA rank (higher = more parameters)
...
logger.info(f"Trainable LoRA parameter tensors in text_model: {cnt_trainable}")
logger.info(f"Total LoRA parameter tensors: {cnt_total}")
...
# ============================================================================
logger.info("[7/9] Initializing Weights & Biases...")
wandb.init(
    project="IE643_SmolVLM_Finetuning", 
    name="smolvlm-256M-run-language-head-finetuning-simple-arithmetics-stage2",
)
...
# ============================================================================
logger.info("[8/9] Configuring training parameters...")

training_args = SFTConfig(
    overwrite_output_dir=False,

    # Output directory for checkpoints
    output_dir="/home/ie643_mindspring/model_weights/training-language-head-simple-arithmetics-stage1",
...
# ============================================================================
logger.info("[9/9] Initializing trainer...")
...
trainer.train(resume_from_checkpoint="/home/ie643_mindspring/model_weights/training-language-head-simple-arithmetics-stage1/checkpoint-300")

logger.info("\n" + "=" * 60)
logger.info("TRAINING COMPLETED")
logger.info("=" * 60)
logger.info(f"Model checkpoints saved to: {training_args.output_dir}")
logger.info("=" * 60)